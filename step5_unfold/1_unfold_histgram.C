...
int main(int argc, char** argv){
   ...
   TString which_sample = argv[7]; // SingleMuon, ...
   ...
   TString outname= outdir + "/" + which_year + "_" + which_channel + "CHANNEL_" + which_type + "_" + which_region + "_" +  which_btag_workpoint + "_btag_" + which_sample + "_unfold.root";
   ...
   cout<<"\033[34mregion          : "<<which_region<<"\033[0m"<<endl;
