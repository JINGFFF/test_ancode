...
Double_t tdbins[7] = {0,1,2,3,4,5,6};
...
TH1D * hist_Mjj_detajj = new TH1D("hist_Mjj_detajj","hist_Mjj_detajj", 6, tdbins);
...
TH2D * hist_gen_Mjj_detajj = new TH2D("hist_gen_Mjj_detajj","hist_gen_Mjj_detajj", 6, tdbins, 6, tdbins);
...
TH2D * hist_outgen_Mjj_detajj = new TH2D("hist_outgen_Mjj_detajj","hist_outgen_Mjj_detajj", 6, tdbins, 6, tdbins);
...
void test::endJob() {
   ...
   hist_gen_Mva->Write();
   hist_gen_Mjj_Signal->Write();
   hist_gen_Mjj_Control->Write();

   hist_outgen_ptlep->Write();
   hist_outgen_photonEt->Write();
   hist_outgen_jet1pt->Write();
   hist_outgen_Mva->Write();
   hist_outgen_Mjj_Signal->Write();
   hist_outgen_Mjj_Control->Write();
...
void test::hist_Sumw2()
{
   ...
   hist_jet1pt->Sumw2();
   hist_Mva->Sumw2();
   hist_Mjj_Signal->Sumw2();
   hist_Mjj_Control->Sumw2();

   hist_gen_ptlep->Sumw2();
   hist_gen_photonEt->Sumw2();
   hist_gen_jet1pt->Sumw2();
   hist_gen_Mva->Sumw2();
   hist_gen_Mjj_Signal->Sumw2();
   hist_gen_Mjj_Control->Sumw2();

   hist_outgen_ptlep->Sumw2();
   hist_outgen_photonEt->Sumw2();
   hist_outgen_jet1pt->Sumw2();
   hist_outgen_Mva->Sumw2();
...
{
   if(m_type == "mc"){
      hist_ptlep->Scale(1/(p_event - n_event));
      hist_photonEt->Scale(1/(p_event - n_event));
      hist_jet1pt->Scale(1/(p_event - n_event));
      hist_Mva->Scale(1/(p_event - n_event));
      hist_Mjj_Signal->Scale(1/(p_event - n_event));
      hist_Mjj_Control->Scale(1/(p_event - n_event));

      hist_gen_ptlep->Scale(1/(p_event - n_event));
      hist_gen_photonEt->Scale(1/(p_event - n_event));
      hist_gen_jet1pt->Scale(1/(p_event - n_event));
      hist_gen_Mva->Scale(1/(p_event - n_event));
      hist_gen_Mjj_Signal->Scale(1/(p_event - n_event));
      hist_gen_Mjj_Control->Scale(1/(p_event - n_event));

      hist_outgen_ptlep->Scale(1/(p_event - n_event));
      hist_outgen_photonEt->Scale(1/(p_event - n_event));
      hist_outgen_jet1pt->Scale(1/(p_event - n_event));
      hist_outgen_Mva->Scale(1/(p_event - n_event));
...
//cout<<"JEC_up: "<< *photonet<<" "<<*photoneta<<" "<<*photonphi<< " "<<*photone<<" "<<*ptVlepJEC_JEC_up<<" "<<*yVlepJEC_JEC_up<<" "<<*phiVlepJEC_JEC_up<<" "<<*massVlepJEC_JEC_up<< " "<<(vp4_jec_up).M()<<" "<<fill_Mva_JEC_up<<endl;
      ...
      muon_cut_signal_region = fill_HLT_muon==1
                 ...
                 && fill_photonhaspixelseed==0 && fill_photonet>25. 
                 //&& fill_photonet < 400.
                 && fill_MET_et>30. 
     ...
     gen_muon_cut_control_region = genlep==13 && genlep1pt>30 && fabs(genlep1eta)<2.4
      ...
      electron_cut_control_region = fill_HLT_electron==1
                 ...
                 && fill_ngoodmus==0 && fill_ngoodeles==1 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
                 && fill_MET_et>30. //&& fill_mtVlepJECnew>30
                 && fill_drla>0.5 && fill_drj1l>0.5 && fill_drj2l>0.5 && fill_drj1a>0.5 && fill_drj2a>0.5
                 //&& fabs(fill_j1metPhi)>0.5 && fabs(fill_j2metPhi)>0.5
                 && fill_jet1deepcsv < cut_value[1] && fill_jet2deepcsv < cut_value[1]
                 && fabs(fill_Mla - 91.2) > 10;
     ...
     gen_electron_cut_control_region = genlep==11 && genlep1pt>30 && fabs(genlep1eta)<2.5
      ...
      if(m_channel == "electron"){
         if (m_region == "signal"){
            ...
            cut2 = gen_electron_cut_signal_region;

         }
         else if (m_region == "control"){
            cut1 = electron_cut_control_region;
            cut2 = gen_electron_cut_control_region;

         }
         else if (m_region == "aqgc"){
            cut1 = electron_cut_aqgc_region;
            cut2 = gen_electron_cut_aqgc_region;
...
if(genlep1pt>30 &&fabs(genlep1eta)<2.4) s2 = s2+1;

if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 ) s3 = s3+1;
if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) ) s4 = s4+1;

if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) && genjet1pt>40 && genjet2pt>30 ) s5 = s5+1;
if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) && genjet1pt>40 && genjet2pt>30 && fabs(genjet1eta)<4.7 && fabs(genjet2eta)<4.7) s6 = s6+1;

if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) && genjet1pt>40 && genjet2pt>30 && fabs(genjet1eta)<4.7 && fabs(genjet2eta)<4.7 && gendrla1>0.5) s7 = s7+1;

if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) && genjet1pt>40 && genjet2pt>30 && fabs(genjet1eta)<4.7 && fabs(genjet2eta)<4.7 && gendrla1>0.5 && gendrj1a>0.5 ) s8 = s8+1;

if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) && genjet1pt>40 && genjet2pt>30 && fabs(genjet1eta)<4.7 && fabs(genjet2eta)<4.7 && gendrla1>0.5 && gendrj1a>0.5 && gendrj2a>0.5 ) s9 = s9+1;

if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) && genjet1pt>40 && genjet2pt>30 && fabs(genjet1eta)<4.7 && fabs(genjet2eta)<4.7 && gendrla1>0.5 && gendrj1a>0.5 && gendrj2a>0.5 && gendrj1l>0.5) s10 = s10+1;

if(genlep1pt>30 &&fabs(genlep1eta)<2.4 && genphotonet>25 && genphotonet<400 && ((fabs(genphotoneta)<2.5&&fabs(genphotoneta)>1.566) || (fabs(genphotoneta)<1.4442)) && genjet1pt>40 && genjet2pt>30 && fabs(genjet1eta)<4.7 && fabs(genjet2eta)<4.7 && gendrla1>0.5 && gendrj1a>0.5 && gendrj2a>0.5 && gendrj1l>0.5 && gendrj2l>0.5) s11 = s11+1;
...
cout<<n1<<"  reco: "<<cut1<<"   gen: "<<cut2<<endl;
cout<<"reco lep: "<<fill_lep<<"   gen lep: "<<genlep<<endl;
//cout<<"reco Mjj: "<<fill_Mjj<<"   gen Mjj: "<<genMjj<<endl;
//cout<<"reco Mva: "<<fill_Mva<<"   gen Mva: "<<genWGmass<<endl;
cout<<"reco ptlep: "<<fill_ptlep1<<"   gen ptlep: "<<genlep1pt<<endl;
cout<<"reco Met: "<<fill_MET_et<<"   gen Met: "<<*genMET<<endl;
cout<<"reco photonpt: "<<fill_photonet<<"   gen photonpt: "<<genphotonet<<endl;

cout<<"genjetptlist: "<<genjet_pt[0]<<" "<<genjet_pt[1]<<" "<<genjet_pt[2]<<" "<<genjet_pt[3]<<" "<<genjet_pt[4]<<" "<<genjet_pt[5]<<endl;

cout<<"reco jet1pt: "<<fill_jet1pt<<"   gen jet1pt: "<<genjet1pt<<" "<<jet_index[0]<<endl;
cout<<"reco jet2pt: "<<fill_jet2pt<<"   gen jet2pt: "<<genjet2pt<<" "<<jet_index[1]<<endl;
cout<<"reco jet1eta: "<<fill_jet1eta<<"   gen jet1eta: "<<genjet1eta<<"   genjetetalist: "<<genjet_eta[0]<<" "<<genjet_eta[1]<<" "<<genjet_eta[2]<<" "<<genjet_eta[3]<<" "<<genjet_eta[4]<<" "<<genjet_eta[5]<<endl;
cout<<"reco jet2eta: "<<fill_jet2eta<<"   gen jet2eta: "<<genjet2eta<<endl;
cout<<"reco drla: "<<fill_drla<<"   gen drla: "<<gendrla1<<endl;
cout<<"reco drj1l: "<<fill_drj1l<<"   gen drj1l: "<<gendrj1l<<endl;
cout<<"reco drj2l: "<<fill_drj2l<<"   gen drj2l: "<<gendrj2l<<endl;
cout<<"reco drj1a: "<<fill_drj1a<<"   gen drj1a: "<<gendrj1a<<endl;
cout<<"reco drj2a: "<<fill_drj2a<<"   gen dj2a: "<<gendrj2a<<endl;
//cout<<"reco zepp: "<<fill_zepp<<"   gen zepp: "<<genzepp<<endl;
//cout<<"reco detajj: "<<fill_deltaeta<<"   gen detajj: "<<gendetajj<<endl;
//cout<<"reco deta_phi: "<<fill_Dphiwajj<<"   gen deta_phi: "<<gendelta_phi<<endl;

}
}
cout<<n<<" "<<n1<<"   "<<s1<<" "<<s2<<" "<<s3<<" "<<s4<<" "<<s5<<" "<< s6<<" "<<s7<<" "<<s8<<" "<<s9<<" "<<s10<<" "<<s11<<" "<<n2<<endl;
*/
...
//cout<<"pass"<<endl;
      ...
      if(fill_Mva>2000) fill_Mva =1999;

//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      // fill histogram
      // barrel
      if (fabs(fill_photonsceta) < 1.4442){
         if(m_type == "data") { 
            ...
            weight = barrel_fake_photon_weight; //weight_jec_up = weight; weight_jec_down = weight; weight_jer_up = weight; weight_jer_down = weight;

         }
         else if(m_type == "doublefake") { 
            weight = fake_lepton_weight * barrel_fake_photon_weight; //weight_jec_up = weight; weight_jec_down = weight; weight_jer_up = weight; weight_jer_down = weight;
         ...
         if(cut2){
            ...
            if(fill_Mjj>500. &&fill_Mjj<800. &&fill_deltaeta>2.5 &&fill_deltaeta<4.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_gen_Mjj_detajj->Fill(0.5,0.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_gen_Mjj_detajj->Fill(1.5,0.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_gen_Mjj_detajj->Fill(2.5,0.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_gen_Mjj_detajj->Fill(3.5,0.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_gen_Mjj_detajj->Fill(4.5,0.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_gen_Mjj_detajj->Fill(5.5,0.5,weight);
            }

            if(fill_Mjj>=800. &&fill_Mjj<1200. &&fill_deltaeta>2.5 &&fill_deltaeta<4.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_gen_Mjj_detajj->Fill(0.5,1.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_gen_Mjj_detajj->Fill(1.5,1.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_gen_Mjj_detajj->Fill(2.5,1.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_gen_Mjj_detajj->Fill(3.5,1.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_gen_Mjj_detajj->Fill(4.5,1.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_gen_Mjj_detajj->Fill(5.5,1.5,weight);
            }

            if(fill_Mjj>=1200. &&fill_Mjj<2000. &&fill_deltaeta>2.5 &&fill_deltaeta<4.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_gen_Mjj_detajj->Fill(0.5,2.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_gen_Mjj_detajj->Fill(1.5,2.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_gen_Mjj_detajj->Fill(2.5,2.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_gen_Mjj_detajj->Fill(3.5,2.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_gen_Mjj_detajj->Fill(4.5,2.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_gen_Mjj_detajj->Fill(5.5,2.5,weight);
            }


            if(fill_Mjj>500. &&fill_Mjj<800. &&fill_deltaeta>4.5 &&fill_deltaeta<6.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_gen_Mjj_detajj->Fill(0.5,3.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_gen_Mjj_detajj->Fill(1.5,3.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_gen_Mjj_detajj->Fill(2.5,3.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_gen_Mjj_detajj->Fill(3.5,3.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_gen_Mjj_detajj->Fill(4.5,3.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_gen_Mjj_detajj->Fill(5.5,3.5,weight);
            }

            if(fill_Mjj>=800. &&fill_Mjj<1200. &&fill_deltaeta>4.5 &&fill_deltaeta<6.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_gen_Mjj_detajj->Fill(0.5,4.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_gen_Mjj_detajj->Fill(1.5,4.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_gen_Mjj_detajj->Fill(2.5,4.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_gen_Mjj_detajj->Fill(3.5,4.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_gen_Mjj_detajj->Fill(4.5,4.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_gen_Mjj_detajj->Fill(5.5,4.5,weight);
            }

            if(fill_Mjj>=1200. &&fill_Mjj<2000. &&fill_deltaeta>4.5 &&fill_deltaeta<6.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_gen_Mjj_detajj->Fill(0.5,5.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_gen_Mjj_detajj->Fill(1.5,5.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_gen_Mjj_detajj->Fill(2.5,5.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_gen_Mjj_detajj->Fill(3.5,5.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_gen_Mjj_detajj->Fill(4.5,5.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_gen_Mjj_detajj->Fill(5.5,5.5,weight);
            }
            ...
            if(fill_Mjj>500. &&fill_Mjj<800. &&fill_deltaeta>2.5 &&fill_deltaeta<4.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_outgen_Mjj_detajj->Fill(0.5,0.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_outgen_Mjj_detajj->Fill(1.5,0.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_outgen_Mjj_detajj->Fill(2.5,0.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_outgen_Mjj_detajj->Fill(3.5,0.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_outgen_Mjj_detajj->Fill(4.5,0.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_outgen_Mjj_detajj->Fill(5.5,0.5,weight);
            }

            if(fill_Mjj>=800. &&fill_Mjj<1200. &&fill_deltaeta>2.5 &&fill_deltaeta<4.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_outgen_Mjj_detajj->Fill(0.5,1.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_outgen_Mjj_detajj->Fill(1.5,1.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_outgen_Mjj_detajj->Fill(2.5,1.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_outgen_Mjj_detajj->Fill(3.5,1.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_outgen_Mjj_detajj->Fill(4.5,1.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_outgen_Mjj_detajj->Fill(5.5,1.5,weight);
            }

            if(fill_Mjj>=1200. &&fill_Mjj<2000. &&fill_deltaeta>2.5 &&fill_deltaeta<4.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_outgen_Mjj_detajj->Fill(0.5,2.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_outgen_Mjj_detajj->Fill(1.5,2.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_outgen_Mjj_detajj->Fill(2.5,2.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_outgen_Mjj_detajj->Fill(3.5,2.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_outgen_Mjj_detajj->Fill(4.5,2.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_outgen_Mjj_detajj->Fill(5.5,2.5,weight);
            }


            if(fill_Mjj>500. &&fill_Mjj<800. &&fill_deltaeta>4.5 &&fill_deltaeta<6.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_outgen_Mjj_detajj->Fill(0.5,3.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_outgen_Mjj_detajj->Fill(1.5,3.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_outgen_Mjj_detajj->Fill(2.5,3.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_outgen_Mjj_detajj->Fill(3.5,3.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_outgen_Mjj_detajj->Fill(4.5,3.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_outgen_Mjj_detajj->Fill(5.5,3.5,weight);
            }

            if(fill_Mjj>=800. &&fill_Mjj<1200. &&fill_deltaeta>4.5 &&fill_deltaeta<6.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_outgen_Mjj_detajj->Fill(0.5,4.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_outgen_Mjj_detajj->Fill(1.5,4.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_outgen_Mjj_detajj->Fill(2.5,4.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_outgen_Mjj_detajj->Fill(3.5,4.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_outgen_Mjj_detajj->Fill(4.5,4.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_outgen_Mjj_detajj->Fill(5.5,4.5,weight);
            }

            if(fill_Mjj>=1200. &&fill_Mjj<2000. &&fill_deltaeta>4.5 &&fill_deltaeta<6.5){
               if(genMjj>500. &&genMjj<800. &&gendetajj>2.5 &&gendetajj<4.5)    hist_outgen_Mjj_detajj->Fill(0.5,5.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>2.5 &&gendetajj<4.5)  hist_outgen_Mjj_detajj->Fill(1.5,5.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>2.5 &&gendetajj<4.5) hist_outgen_Mjj_detajj->Fill(2.5,5.5,weight);
               if(genMjj>500. &&genMjj<800. &&gendetajj>4.5 &&gendetajj<6.5)    hist_outgen_Mjj_detajj->Fill(3.5,5.5,weight);
               if(genMjj>=800. &&genMjj<1200. &&gendetajj>4.5 &&gendetajj<6.5)  hist_outgen_Mjj_detajj->Fill(4.5,5.5,weight);
               if(genMjj>=1200. &&genMjj<2000. &&gendetajj>4.5 &&gendetajj<6.5) hist_outgen_Mjj_detajj->Fill(5.5,5.5,weight);
            }
      ...
      // endcap
      if (fabs(fill_photonsceta) > 1.566 && fabs(fill_photonsceta) < 2.5){
         if(m_type == "data") { 
            weight = 1; //weight_jec_up = 1; weight_jec_down = 1; weight_jer_up = 1; weight_jer_down = 1;
            ...
            weight = endcap_fake_photon_weight; //weight_jec_up = weight; weight_jec_down = weight; weight_jer_up = weight; weight_jer_down = weight;
         }
         else if(m_type == "doublefake") { 
            weight = fake_lepton_weight * barrel_fake_photon_weight; //weight_jec_up = weight; weight_jec_down = weight; weight_jer_up = weight; weight_jer_down = weight;
