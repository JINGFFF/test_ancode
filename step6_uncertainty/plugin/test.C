...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < 1.4442){
         if(m_type == "data") { 
            ...
            if (cut3) {
               h[0][18]->Fill(fill_var_barrel[0],fill_weight_barrel[18]);
               h[1][18]->Fill(fill_var_barrel[1],fill_weight_barrel[18]);
               h[2][18]->Fill(fill_var_barrel[2],fill_weight_barrel[18]);
               h[3][18]->Fill(fill_var_barrel[3],fill_weight_barrel[18]);
               h[4][18]->Fill(fill_var_barrel[4],fill_weight_barrel[18]);
               h[5][18]->Fill(fill_var_barrel[5],fill_weight_barrel[18]);
               h2D[18]->Fill(fill_Mjj,fill_deltaeta,fill_weight_barrel[18]);
