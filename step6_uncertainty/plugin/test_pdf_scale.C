...
vector<double> ptlepBins={20,100,400};
vector<double> photonEtBins={20,100,400};
vector<double> jetptBins={30,550,800};
vector<double> MvaBins={100,150,1000};
vector<double> Mjj_Signal_Bins={500,1000,2000};
vector<double> Mjj_Control_Bins={500,1000,2000};

Double_t mjj_bins[4]={500, 800, 1200, 2000};
Double_t detajj_bins[3]={2.5, 4.5, 6.5};


double bin_num[6] = {2, 2, 2, 2, 2, 2};
TString var[7] = {"ptlep", "photonEt", "jet1pt", "Mva", "Mjj_Signal", "Mjj_Control", "Mjj_detajj"};
TString uncertainty_hist_name[21] = {"", "photon_ID_up", "photon_ID_down", "electron_ID_up", "electron_ID_down", "electron_Reco_up", "electron_Reco_down", "electron_HLT_up", "electron_HLT_down", "muon_ID_up", "muon_ID_down", "muon_iso_up", "muon_iso_down", "muon_HLT_up", "muon_HLT_down", "fakephoton_up", "fakephoton_down", "JEC_up", "JEC_down", "JER_up", "JER_down"};
...
void test::creat_hist(){
   ...
   bins.push_back(Mjj_Signal_Bins);
   bins.push_back(Mjj_Control_Bins);
   ...
   for (int i = 0; i < 6; i++){
      ...
      for(int j = 0; j<21; j++){
         h[i][j] = new TH1D("hist_"+var[i]+"_"+uncertainty_hist_name[j],"hist_"+var[i]+"_"+uncertainty_hist_name[j], bin_num[i], BINS); 
      }
      
      for(int k2 = 0; k2<400; k2++){
         sprintf(th2name,"%d",k2);
         h2[i][k2] = new TH1D("hist_"+var[i]+"_pdf_scale_" + th2name,"hist_" + var[i] + "_pdf_scale_" + th2name, bin_num[i], BINS);

      }

   }

   for(int k3 = 0; k3<400; k3++){
      sprintf(th2name,"%d",k3);
      h2_2D[k3] = new TH2D("hist2D_"+var[6]+"_pdf_scale_" + th2name,"hist2D_" + var[6] + "_pdf_scale_" + th2name,  3, mjj_bins, 2, detajj_bins);

   }
   for(int k = 0; k<21; k++){
         h2D[k] = new TH2D("hist2D_"+var[6]+"_"+uncertainty_hist_name[k],"hist2D_"+var[6]+"_"+uncertainty_hist_name[k], 3, mjj_bins, 2, detajj_bins);
   }
...
void test::hist_Scale()
{
   if(m_type == "mc"){
      for (int i = 0; i < 6; i++){
         for(int j = 0; j<21; j++){
            h[i][j]->Scale(1/(p_event - n_event));
         }

         for(int k2 = 0; k2<400; k2++){
            h2[i][k2]->Scale(1/(p_event - n_event));
         }

      }

      for(int k3 = 0; k3<400; k3++){
         h2_2D[k3]->Scale(1/(p_event - n_event));

      }

      for(int k = 0; k<21; k++){
         h2D[k]->Scale(1/(p_event - n_event));
      }
...
//cout<<fill_Mva_JEC_up<<endl;
      ...
      muon_cut_signal_region_jec_down = fill_HLT_muon==1
                 ...
                 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
                 && fill_MET_et_JEC_down>30. //&& fill_mtVlepJECnew_JEC_down>30
      ...
      muon_cut_signal_region_jer_up = fill_HLT_muon==1
                 ...
                 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
                 && fill_MET_et_JER_up>30. //&& fill_mtVlepJECnew_JER_up>30
      ...
      electron_cut_signal_region_jec_up = fill_HLT_electron==1
                 ...
                 && fill_ngoodmus==0 && fill_ngoodeles==1 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
                 && fill_MET_et_JEC_up>30. //&& fill_mtVlepJECnew_JEC_up>30
                 && fill_drla>0.5 && fill_drj1l_JEC_up>0.5 && fill_drj2l_JEC_up>0.5 && fill_drj1a_JEC_up>0.5 && fill_drj2a_JEC_up>0.5
                 //&& fabs(fill_j1metPhi_JEC_up)>0.5 && fabs(fill_j2metPhi_JEC_up)>0.5
                 && fill_jet1deepcsv_JEC_up < cut_value[1] && fill_jet2deepcsv_JEC_up < cut_value[1]
                 && fabs(fill_Mla - 91.2) > 10; 
      ...
      muon_cut_control_region_jec_up = fill_HLT_muon==1
                 && fill_Mjj_JEC_up>200. && fill_Mjj_JEC_up<400.
                 && fill_jet1pt_JEC_up>40. && fabs(fill_jet1eta_JEC_up)<4.7 && fill_jet2pt_JEC_up>30. && fabs(fill_jet2eta_JEC_up)<4.7
                 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4
                 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
      ...
      muon_cut_control_region_jec_down = fill_HLT_muon==1
                 && fill_Mjj_JEC_down>200. && fill_Mjj_JEC_down<400.
                 && fill_jet1pt_JEC_down>40. && fabs(fill_jet1eta_JEC_down)<4.7 && fill_jet2pt_JEC_down>30. && fabs(fill_jet2eta_JEC_down)<4.7
                 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4
                 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
      ...
      muon_cut_control_region_jer_up = fill_HLT_muon==1
                 && fill_Mjj_JER_up>200. && fill_Mjj_JER_up<400.
                 && fill_jet1pt_JER_up>40. && fabs(fill_jet1eta_JER_up)<4.7 && fill_jet2pt_JER_up>30. && fabs(fill_jet2eta_JER_up)<4.7
                 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4
                 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
      ...
      muon_cut_control_region_jer_down = fill_HLT_muon==1
                 && fill_Mjj_JER_down>200. && fill_Mjj_JER_down<400.
                 && fill_jet1pt_JER_down>40. && fabs(fill_jet1eta_JER_down)<4.7 && fill_jet2pt_JER_down>30. && fabs(fill_jet2eta_JER_down)<4.7
                 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4
                 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1
                 && fill_photonhaspixelseed==0 && fill_photonet>25. //&& fill_photonet < 400.
...
*/
      ...
      if(fill_Mva_JEC_up>2000) fill_Mva_JEC_up =1999;
      if(fill_Mva_JEC_down>2000) fill_Mva_JEC_down =1999;
      if(fill_Mva_JER_up>2000) fill_Mva_JER_up =1999;
      if(fill_Mva_JER_down>2000) fill_Mva_JER_down =1999;
...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < 1.4442){
         if(m_type == "data") { 
            ...
            double fill_var_barrel[6] = {fill_ptlep1, fill_photonet, fill_jet1pt, fill_Mva, fill_Mjj, fill_Mjj};
            double fill_weight_barrel[21] = {weight, weight_photon_ID_up, weight_photon_ID_down, weight_electron_ID_up, weight_electron_ID_down, weight_electron_Reco_up, weight_electron_Reco_down, weight_electron_HLT_up, weight_electron_HLT_down, weight_muon_ID_up, weight_muon_ID_down, weight_muon_iso_up, weight_muon_iso_down, weight_muon_HLT_up, weight_muon_HLT_down, weight_fakephoton_up, weight_fakephoton_down, weight, weight, weight, weight};
            if (cut1) {
               for (int i = 0; i < 6; i++){
                  for(int j = 0; j<17; j++){
                     h[i][j]->Fill(fill_var_barrel[i],fill_weight_barrel[j]);
                  }

                  for(int iw = 0; iw<400; iw++){
                     h2[i][iw]->Fill(fill_var_barrel[i],fill_weight_barrel[0]*pweight[iw+225]);
                  }
               }

               for(int iw_2d = 0; iw_2d<400; iw_2d++){
                  h2_2D[iw_2d]->Fill(fill_Mjj,fill_deltaeta,fill_weight_barrel[0]*pweight[iw_2d+225]);
               }


               for(int k = 0; k<17; k++){
                  h2D[k]->Fill(fill_Mjj,fill_deltaeta,fill_weight_barrel[k]);
               }
            ...
            if (cut2) {
               h[0][17]->Fill(fill_var_barrel[0],fill_weight_barrel[17]);
               h[1][17]->Fill(fill_var_barrel[1],fill_weight_barrel[17]);
               h[2][17]->Fill(fill_var_barrel[2],fill_weight_barrel[17]);
               h[3][17]->Fill(fill_var_barrel[3],fill_weight_barrel[17]);
               h[4][17]->Fill(fill_var_barrel[4],fill_weight_barrel[17]);
               h[5][17]->Fill(fill_var_barrel[5],fill_weight_barrel[17]);
               h2D[17]->Fill(fill_Mjj,fill_deltaeta,fill_weight_barrel[17]);
            }
            if (cut3) {
               h[0][18]->Fill(fill_var_barrel[0],fill_weight_barrel[19]);
               h[1][18]->Fill(fill_var_barrel[1],fill_weight_barrel[19]);
               h[2][18]->Fill(fill_var_barrel[2],fill_weight_barrel[19]);
               h[3][18]->Fill(fill_var_barrel[3],fill_weight_barrel[19]);
               h[4][18]->Fill(fill_var_barrel[4],fill_weight_barrel[19]);
               h[5][18]->Fill(fill_var_barrel[5],fill_weight_barrel[19]);
               h2D[18]->Fill(fill_Mjj,fill_deltaeta,fill_weight_barrel[19]);

            }
            if (cut4) {
               h[0][19]->Fill(fill_var_barrel[0],fill_weight_barrel[19]);
               h[1][19]->Fill(fill_var_barrel[1],fill_weight_barrel[19]);
               h[2][19]->Fill(fill_var_barrel[2],fill_weight_barrel[19]);
               h[3][19]->Fill(fill_var_barrel[3],fill_weight_barrel[19]);
               h[4][19]->Fill(fill_var_barrel[4],fill_weight_barrel[19]);
               h[5][19]->Fill(fill_var_barrel[5],fill_weight_barrel[19]);
               h2D[19]->Fill(fill_Mjj,fill_deltaeta,fill_weight_barrel[19]);

            }
            if (cut5) {
               h[0][20]->Fill(fill_var_barrel[0],fill_weight_barrel[20]);
               h[1][20]->Fill(fill_var_barrel[1],fill_weight_barrel[20]);
               h[2][20]->Fill(fill_var_barrel[2],fill_weight_barrel[20]);
               h[3][20]->Fill(fill_var_barrel[3],fill_weight_barrel[20]);
               h[4][20]->Fill(fill_var_barrel[4],fill_weight_barrel[20]);
               h[5][20]->Fill(fill_var_barrel[5],fill_weight_barrel[20]);
               h2D[20]->Fill(fill_Mjj,fill_deltaeta,fill_weight_barrel[20]);
      ...
      if (fabs(fill_photonsceta) > 1.566 && fabs(fill_photonsceta) < 2.5){
         if(m_type == "data") { 
            ...
            weight = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;            weight_photon_ID_up = cross_section_SF * pu_weight_SF * photon_ID_up_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_photon_ID_down = cross_section_SF * pu_weight_SF * photon_ID_low_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_electron_ID_up = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_up_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_electron_ID_down = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_low_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_electron_Reco_up = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_up_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            ...
            double fill_var_endcap[6] = {fill_ptlep1, fill_photonet, fill_jet1pt, fill_Mva, fill_Mjj, fill_Mjj};
            double fill_weight_endcap[21] = {weight, weight_photon_ID_up, weight_photon_ID_down, weight_electron_ID_up, weight_electron_ID_down, weight_electron_Reco_up, weight_electron_Reco_down, weight_electron_HLT_up, weight_electron_HLT_down, weight_muon_ID_up, weight_muon_ID_down, weight_muon_iso_up, weight_muon_iso_down, weight_muon_HLT_up, weight_muon_HLT_down, weight_fakephoton_up, weight_fakephoton_down, weight, weight, weight, weight};
            if (cut1) {
               for (int i = 0; i < 6; i++){
                  for(int j = 0; j<17; j++){
                     h[i][j]->Fill(fill_var_endcap[i],fill_weight_endcap[j]);
                  }

                  for(int iw = 0; iw<400; iw++){
                     h2[i][iw]->Fill(fill_var_endcap[i],fill_weight_endcap[0]*pweight[iw+225]);
                  }

               for(int iw_2d = 0; iw_2d<400; iw_2d++){
                  h2_2D[iw_2d]->Fill(fill_Mjj,fill_deltaeta,fill_weight_endcap[0]*pweight[iw_2d+225]);
               }


               }
               for(int k = 0; k<17; k++){
                  h2D[k]->Fill(fill_Mjj,fill_deltaeta,fill_weight_endcap[k]);
               }


            }
            if (cut2) {
               h[0][17]->Fill(fill_var_endcap[0],fill_weight_endcap[17]);
               h[1][17]->Fill(fill_var_endcap[1],fill_weight_endcap[17]);
               h[2][17]->Fill(fill_var_endcap[2],fill_weight_endcap[17]);
               h[3][17]->Fill(fill_var_endcap[3],fill_weight_endcap[17]);
               h[4][17]->Fill(fill_var_endcap[4],fill_weight_endcap[17]);
               h[5][17]->Fill(fill_var_endcap[5],fill_weight_endcap[17]);
               h2D[17]->Fill(fill_Mjj,fill_deltaeta,fill_weight_endcap[17]);


            }
            if (cut3) {
               h[0][18]->Fill(fill_var_endcap[0],fill_weight_endcap[18]);
               h[1][18]->Fill(fill_var_endcap[1],fill_weight_endcap[18]);
               h[2][18]->Fill(fill_var_endcap[2],fill_weight_endcap[18]);
               h[3][18]->Fill(fill_var_endcap[3],fill_weight_endcap[18]);
               h[4][18]->Fill(fill_var_endcap[4],fill_weight_endcap[18]);
               h[5][18]->Fill(fill_var_endcap[5],fill_weight_endcap[18]);
               h2D[18]->Fill(fill_Mjj,fill_deltaeta,fill_weight_endcap[18]);

            }
            if (cut4) {
               h[0][19]->Fill(fill_var_endcap[0],fill_weight_endcap[19]);
               h[1][19]->Fill(fill_var_endcap[1],fill_weight_endcap[19]);
               h[2][19]->Fill(fill_var_endcap[2],fill_weight_endcap[19]);
               h[3][19]->Fill(fill_var_endcap[3],fill_weight_endcap[19]);
               h[4][19]->Fill(fill_var_endcap[4],fill_weight_endcap[19]);
               h[5][19]->Fill(fill_var_endcap[5],fill_weight_endcap[19]);
               h2D[19]->Fill(fill_Mjj,fill_deltaeta,fill_weight_endcap[19]);

            }
            if (cut5) {
               h[0][20]->Fill(fill_var_endcap[0],fill_weight_endcap[20]);
               h[1][20]->Fill(fill_var_endcap[1],fill_weight_endcap[20]);
               h[2][20]->Fill(fill_var_endcap[2],fill_weight_endcap[20]);
               h[3][20]->Fill(fill_var_endcap[3],fill_weight_endcap[20]);
               h[4][20]->Fill(fill_var_endcap[4],fill_weight_endcap[20]);
               h[5][20]->Fill(fill_var_endcap[5],fill_weight_endcap[20]);
               h2D[20]->Fill(fill_Mjj,fill_deltaeta,fill_weight_endcap[20]);
