...
input_filename_m = indir + '/' + year + '_' + channel +'_' + operator + '_paramsets_.txt'
...
#newFormatInput6 = TH1D('electron_aqgc_scaling_bin_1','electron_aqgc_scaling_bin_1',nGridPointsForNewF,par1GridMin,par1GridMax)
#newFormatInput7 = TH1D('electron_aqgc_scaling_bin_2','electron_aqgc_scaling_bin_2',nGridPointsForNewF,par1GridMin,par1GridMax)
#newFormatInput8 = TH1D('electron_aqgc_scaling_bin_3','electron_aqgc_scaling_bin_3',nGridPointsForNewF,par1GridMin,par1GridMax)
#newFormatInput9 = TH1D('electron_aqgc_scaling_bin_4','electron_aqgc_scaling_bin_4',nGridPointsForNewF,par1GridMin,par1GridMax)
#newFormatInput10 = TH1D('electron_aqgc_scaling_bin_5','electron_aqgc_scaling_bin_5',nGridPointsForNewF,par1GridMin,par1GridMax)
hists = []
